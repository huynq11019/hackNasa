...
$(".right-bar-btn").click(function(){
  $("body").toggleClass("right-bar-toggle");
	  ...
	  var bar = new ProgressBar.Circle(rightprogressbar1, {
		  color: '#ff339e',
		  ...
		  from: { color: '#ff339e', width: 4 },
		  to: { color: '#ff339e', width: 4 },
		  ...
		  step: function(state, circle) {
			...
			if (value === 0) {
			  ...
			  circle.setText("<span class='fw-600 fs-18 text-white'>70%</span>");
			}
	  ...
	  var bar = new ProgressBar.Circle(rightprogressbar2, {
		  color: '#623bf0',
		  // This has to be the same size as the maximum width to
		  // prevent clipping
		  strokeWidth: 30,
		  ...
		  from: { color: '#623bf0', width: 4 },
		  to: { color: '#623bf0', width: 4 },
		  // Set default step function for all animate calls
		  step: function(state, circle) {
			circle.path.setAttribute('stroke', state.color);
			circle.path.setAttribute('stroke-width', state.width);
			...
			if (value === 0) {
			  ...
			  circle.setText("<span class='fw-600 fs-18 text-white'>58%</span>");
			}
	  ...
	  var bar = new ProgressBar.Circle(rightprogressbar3, {
		  color: '#ef5630',
		  // This has to be the same size as the maximum width to
		  // prevent clipping
		  strokeWidth: 30,
		  ...
		  from: { color: '#ef5630', width: 8 },
		  to: { color: '#ef5630', width: 8 },
		  // Set default step function for all animate calls
		  step: function(state, circle) {
			circle.path.setAttribute('stroke', state.color);
			circle.path.setAttribute('stroke-width', state.width);
			...
			if (value === 0) {
			  ...
			  circle.setText("<span class='fw-600 fs-18'>1045</span>");
			}
